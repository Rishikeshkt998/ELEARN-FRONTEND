            ...
            <div className=" p-4 w-full max-w-md max-h-full">
                <div className=" bg-white rounded-lg shadow dark:bg-gray-700">
                    <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button ref={closeRef} type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal">
                    ...
                    <form method="post" onSubmit={handleSubmit} className="p-4 md:p-5">
                        <div className="col-span-2">
                            ...
                            <textarea id="question" name="question" rows={3} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="What is JavaScript?" value={values.question} onChange={handleChange} onBlur={handleBlur} />
                        ...
                        <div className="grid gap-4 mb-4 grid-cols-2">
                            {values.options.map((index:any) => (
                                <div key={index} className="col-span-2 sm:col-span-1">
                                    ...
                                    {errors.options && errors.options[index] && <div className="text-red-600 text-sm">{errors.options[index]}</div>}
                                </div>
                            ))}
                        </div>
                        <div className="col-span-2">
                            <label htmlFor="correctOption" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Correct Option</label>
                            <input type="text" name="correctOption" id="correctOption" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value={values.correctOption} onChange={handleChange} onBlur={handleBlur} />
                            {errors.correctOption && <div className="text-red-600 text-sm">{errors.correctOption}</div>}
                        </div>
