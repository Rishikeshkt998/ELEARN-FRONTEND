          ...
          <div className="flex items-center justify-start">
            ...
            <a href="#" className="text-xl font-bold flex items-center lg:ml-2.5">
              <img
                ...
                alt="Windster Logo"
              />
              <span className="self-center whitespace-nowrap text-gray-300">
                ELEARN
              </span>
            </a>
            <form
            ...
            >
              ...
              <div className="mt-1 relative lg:w-64">
                ...
                <input
                  ...
                  name="email"
                  id="topbar-search"
                  className="bg-gray-800 border border-gray-700 text-gray-300 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full pl-10 p-2.5"
                  placeholder="Search"
                />
              </div>
            </form>
