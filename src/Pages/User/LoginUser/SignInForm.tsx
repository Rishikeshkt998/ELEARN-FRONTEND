...
import Oauth from '../../../Components/common/Google/Oauth';
...
const SignInForm: React.FC = () => {
    ...
    const checkPasswordStrength = (password: string) => {
        ...
        if (criteria.hasNumber.test(password)) score++;
        if (criteria.hasSpecialChar.test(password)) score++;
                ...
                <div className="md:flex w-full">
                    ...
                    <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div className="text-center mb-10">
                            <h1 className="font-bold text-3xl text-gray-900">USER LOGIN</h1>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6" action="#">
                                ...
                                <div>
                                    ...
                                    <input type="email" value={email}
                                        onChange={handleEmailChange} name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Your Email " required />
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative w-full mt-2">
                                        <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-gray-300">
                                            <div style={{ width: `${(password.length / 8) * 100}%`, background: getPasswordStrengthColor(passwordStrength) }}></div>
                                        </div>
                                        <p className="text-sm font-light" style={{ color: getPasswordStrengthColor(passwordStrength) }}>
                                            {passwordStrength}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                    <Link to="/forgotpassword" >
                                        Forgot password?
                                    </Link> <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500"></a>
                                </p>
                                ...
                                <div className="block w-full max-w-xs rounded-lg px-3 py-3 font-semibold">
                                    <Oauth />
                                </div>
